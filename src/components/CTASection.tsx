          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="mt-8 flex flex-wrap gap-6 justify-center lg:justify-start text-muted-foreground">
                <a href="https://wa.me/7517935308" className="flex items-center gap-2 hover:text-accent transition-colors">
                  <MessageCircle className="w-5 h-5" />
                  <span>+91 75179 35308</span>
                </a>
